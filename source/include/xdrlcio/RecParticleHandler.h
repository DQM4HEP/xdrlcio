  /// \file RecParticleHandler.h
/*
 *
 * RecParticleHandler.h header template automatically generated by a class generator
...
#ifndef RECPARTICLEHANDLER_H
#define RECPARTICLEHANDLER_H

#include "LCObjectHandler.h"


namespace xdrlcio {

/** 
 * @brief RecParticleHandler class
 */ 
class RecParticleHandler : public LCObjectHandler 
{
public:
	/**
	 *  @brief  Destructor
	 */
	~RecParticleHandler() { /* nop */ }
