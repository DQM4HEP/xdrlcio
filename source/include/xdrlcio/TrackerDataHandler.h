  /// \file TrackerDataHandler.h
/*
 *
 * TrackerDataHandler.h header template automatically generated by a class generator
...
#ifndef TRACKERDATAHANDLER_H
#define TRACKERDATAHANDLER_H
...
/** 
 * @brief TrackerDataHandler class
 */ 
class TrackerDataHandler : public LCObjectHandler 
{
public:
	/**
	 *  @brief  Destructor
	 */
	~TrackerDataHandler() { /* nop */ }
