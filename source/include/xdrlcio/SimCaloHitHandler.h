  /// \file SimCaloHitHandler.h
/*
 *
 * SimCaloHitHandler.h header template automatically generated by a class generator
...
#ifndef SIMCALOHITHANDLER_H
#define SIMCALOHITHANDLER_H
...
/** 
 * @brief SimCaloHitHandler class
 */ 
class SimCaloHitHandler : public LCObjectHandler 
{
public:
	/**
	 *  @brief  Destructor
	 */
	~SimCaloHitHandler() { /* nop */ }
