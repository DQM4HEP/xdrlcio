  /// \file CaloHitHandler.h
/*
 *
 * CaloHitHandler.h header template automatically generated by a class generator
...
#ifndef CALOHITHANDLER_H
#define CALOHITHANDLER_H
...
/** 
 * @brief CaloHitHandler class
 */ 
class CaloHitHandler : public LCObjectHandler 
{
public:
	/**
	 *  @brief  Destructor
